    ...
    >
      ...
      >
        <div class="create-update-modal-title">
          ...
          <span>نمایش درخواست همکاری</span>
        </div>
        <v-spacer/>
      </v-card-title>
      <v-divider/>
        ...
        <v-row>
          ...
          >
            <div class="show-form-text">
              ...
              <span>{{ item.full_name | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <div class="show-form-text">
              ...
              <span>{{ item.skill ? item.skill.name : '-' | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <div class="show-form-text">
              ...
              <span dir-ltr>{{ item.phone_number | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <div class="show-form-text">
              <span>استان</span>
              <span>{{ item.city ? item.city.province.name : '-' | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <div class="show-form-text">
              <span>شهر</span>
              <span>{{ item.city ? item.city.name : '-' | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          >
            <div class="show-form-text">
              <span>آدرس</span>
              <span>{{ item.address | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          >
            <div class="show-form-text">
              <span>توضیحات</span>
              <span>{{ item.description | toPersianNumber }}</span>
            </div>
          </v-col>
        </v-row>
      </v-card-text>
