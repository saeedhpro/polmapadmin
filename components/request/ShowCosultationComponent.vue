    ...
    >
      ...
      >
        <div class="create-update-modal-title">
          ...
          <span>نمایش درخواست مشاوره</span>
        </div>
        <v-spacer/>
      </v-card-title>
      <v-divider/>
        ...
        <v-row>
          ...
          >
            <div class="show-form-text">
              ...
              <span class="dir-ltr">{{ item.phone_number | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
          ...
          >
            <div class="show-form-text">
              ...
              <span class="dir-ltr">{{ item.tel | toPersianNumber }}</span>
            </div>
          </v-col>
          <v-col
            cols="12"
