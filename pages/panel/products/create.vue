          ...
          <div class="account-form">
            <div class="account-form-header">
              <div class="account-form-right-box">
                ...
                <span class="account-form-title">ایجاد محصول</span>
              </div>
              <div class="account-form-action-box">
                <button class="account-form-action main-btn" @click="createProduct">
                  <v-progress-circular v-if="loading" color="#FFF" indeterminate />
                  <span v-else style="color: white">انتشار</span>
                </button>
              </div>
            </div>
            <v-divider/>
...
export default {
  ...
  methods: {
      ...
      if (this.validateProduct()) {
        this.$store.dispatch('product/createProduct', {
          ...
          attributes: [
            ...
            ...this.variable_attributes.map(i => ({
              ...i,
              items: [
                ...i.items.map(j => {
                  return {
    ...
    removeImage(index) {
      this.product.images.splice(index)
    },
    validateProduct() {
      let validated = true
    ...
    canAddSimple(attribute) {
      return !(!attribute.items[attribute.items.length - 1].name ||
