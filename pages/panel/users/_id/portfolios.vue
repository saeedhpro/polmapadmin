          ...
          <div class="account-form">
            <div class="account-form-header">
              <div class="account-form-right-box">
                ...
                <span class="account-form-title">لیست نمونه کارهای کاربر</span>
              </div>
...
export default {
  ...
  mounted() {
    this.filter.user_id = this.$route.params.id
    this.paginate()
  },
  methods: {
    getPortfolios() {
      this.$store.dispatch('portfolio/getPortfolios', this.filter)
    },
    paginate(page = 1) {
